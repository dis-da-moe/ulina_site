...
lazy_static! {
    pub static ref COMMANDS: HashMap<&'static str, UlinaCommand> = {
        ...
        add_commands!(map => ping, nation, remove_nation, commands, create_nation, edit_flag, edit_socials, edit_name_description, all_nations, time, edit_discord_user, guides, pasta);
        map
    };
}
