...
use crate::{
    ...
    show_nation::{field_title, show_info, show_trivia},
};
...
impl Component for Nation {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        ...
        Nation {
            is_mine: loaded.user.owner_discord.as_ref() == Some(&loaded.data.core.ownerDiscord),
            logged_in: loaded.user.owner_discord.is_some(),
            flag_loaded: false,
            optional_fields,
            socials,
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        let is_admin = ctx.props().loaded.user.is_admin;
